...
module noc_stress_tester #(
    ...
    traffic_node_agent #(.DEST_ID(DEST_00), .SRC_TAG(2'b00), .TX_EN(TXEN_00)) agent_00 (
    ...
    traffic_node_agent #(.DEST_ID(DEST_11), .SRC_TAG(2'b11)) agent_11 (
    ...
    traffic_node_agent #(.DEST_ID(DEST_01), .SRC_TAG(2'b01)) agent_01 (
    ...
    traffic_node_agent #(.DEST_ID(DEST_10), .SRC_TAG(2'b10)) agent_10 (
