...
HD_PWD='D:/OpalFolder/MyOwnProject/FPGA/GALS_Packet-Based_Fabric/GALS_Packet-Based_Fabric.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arty_stress_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arty_stress_top.tcl
