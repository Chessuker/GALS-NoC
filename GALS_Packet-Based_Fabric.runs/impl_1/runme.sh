...
HD_PWD='D:/OpalFolder/MyOwnProject/FPGA/GALS_Packet-Based_Fabric/GALS_Packet-Based_Fabric.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log arty_stress_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source arty_stress_top.tcl -notrace
