...
#
# Script generated by Vivado on Thu Jul 30 23:04:34 +0700 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/OpalFolder/MyOwnProject/FPGA/GALS_Packet-Based_Fabric/GALS_Packet-Based_Fabric.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
