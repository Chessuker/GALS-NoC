...
REM
REM Generated by Vivado on Sat Jul 11 13:56:41 +0700 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_noc_mesh_2x2_gals_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_noc_mesh_2x2_gals_vlog.prj -log xvlog.log
